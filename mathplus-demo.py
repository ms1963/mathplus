...
nv = Transfer.vector_to_nparray(v)
print()
print("After transfering it to numpy we get \n" + str(nv))
print("Transferring it back to mathplus results in : " + str(Transfer.nparray_to_vector(nv)))
print()
...
input.append((lambda x: x**2, "g", "y = x**2"))
...
plt.show()
print()
print("Visualization of the Legendre polynomials for n=1,..,5")
x = mp.array.lin_distribution(-1, 1, 100)
input = [] 
input.append((lambda x: Polynomial.legendre(1).compute(x), "r", "n = 1"))
input.append((lambda x: Polynomial.legendre(2).compute(x), "g", "n = 2"))
input.append((lambda x: Polynomial.legendre(3).compute(x), "c", "n = 3"))
input.append((lambda x: Polynomial.legendre(4).compute(x), "y", "n = 4"))
input.append((lambda x: Polynomial.legendre(5).compute(x), "b", "n = 5"))
Transfer.draw_functions_2D(x, input, title = "Legendre polynomials", legend_loc = "lower right")
print()
print("Visualization of the first order Chebyshev polynomials for n=1,..,5")
x = mp.array.lin_distribution(-1, 1, 100)
input = [] 
input.append((lambda x: Polynomial.chebyshev_1(1).compute(x), "r", "n = 1"))
input.append((lambda x: Polynomial.chebyshev_1(2).compute(x), "g", "n = 2"))
input.append((lambda x: Polynomial.chebyshev_1(3).compute(x), "c", "n = 3"))
input.append((lambda x: Polynomial.chebyshev_1(4).compute(x), "y", "n = 4"))
input.append((lambda x: Polynomial.chebyshev_1(5).compute(x), "b", "n = 5"))
Transfer.draw_functions_2D(x, input, title = "Chebyshev polynomials", legend_loc="lower right")
print()
print("Visualization of the Laguerre polynomials for n=1,..,5")
x = mp.array.lin_distribution(0, 5, 100)
input = [] 
input.append((lambda x: Polynomial.laguerre(1).compute(x), "r", "n = 1"))
input.append((lambda x: Polynomial.laguerre(2).compute(x), "g", "n = 2"))
input.append((lambda x: Polynomial.laguerre(3).compute(x), "c", "n = 3"))
input.append((lambda x: Polynomial.laguerre(4).compute(x), "y", "n = 4"))
...
print()
print("Visualization of the Hermite polynomials (physicists) for n=0,..,5")
x = mp.array.lin_distribution(-1.5, 1.5, 100)
input = [] 
input.append((lambda x: Polynomial.hermite_physicists(0).compute(x), "violet", "n = 0"))
input.append((lambda x: Polynomial.hermite_physicists(1).compute(x), "r", "n = 1"))
input.append((lambda x: Polynomial.hermite_physicists(2).compute(x), "g", "n = 2"))
input.append((lambda x: Polynomial.hermite_physicists(3).compute(x), "c", "n = 3"))
input.append((lambda x: Polynomial.hermite_physicists(4).compute(x), "y", "n = 4"))
input.append((lambda x: Polynomial.hermite_physicists(5).compute(x), "b", "n = 5"))
Transfer.draw_functions_2D(x, input, title = "Hermite polynomials (physicists)", legend_loc = "lower left")
print()

print("Visualization of the Hermite polynomials (probabilists) for n=0,..,5")
x = mp.array.lin_distribution(-1.5, 1.5, 100)
input = [] 
input.append((lambda x: Polynomial.hermite_probabilists(0).compute(x), "violet", "n = 0"))
input.append((lambda x: Polynomial.hermite_probabilists(1).compute(x), "r", "n = 1"))
input.append((lambda x: Polynomial.hermite_probabilists(2).compute(x), "g", "n = 2"))
input.append((lambda x: Polynomial.hermite_probabilists(3).compute(x), "c", "n = 3"))
input.append((lambda x: Polynomial.hermite_probabilists(4).compute(x), "y", "n = 4"))
input.append((lambda x: Polynomial.hermite_probabilists(5).compute(x), "b", "n = 5"))
Transfer.draw_functions_2D(x, input, title = "Hermite polynomials (probabilists)", legend_loc = "lower left")
print()
