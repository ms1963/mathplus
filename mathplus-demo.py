...
plt.show()
print()
print("Visualiation of the Legendre polynomials for n=1,..,5")
...
print()
print("Visualiation of the first order Chebyshev polynomials for n=1,..,5")
x = mp.array.lin_distribution(-1, 1, 100)
input = [] 
...
print()
print("Visualiation of the Laguerre polynomials for n=1,..,5")
